...
_EXPORT_MODULES = {
    ...
    "PrepareVmdExportAction": ".prepare_vmd_export_action",
    "PrepareVmdExportError": ".prepare_vmd_export_action",
    "PrepareVmdExportRaceError": ".prepare_vmd_export_action",
    "PrepareVmdExportRequest": ".prepare_vmd_export_action",
    "PrepareVmdExportResult": ".prepare_vmd_export_action",
    "PreparedVmdExportToken": ".prepare_vmd_export_action",
    "PREPARED_VMD_ARTIFACT_SCHEMA_VERSION": ".prepared_vmd_artifact",
    "PreparedVmdArtifactError": ".prepared_vmd_artifact",
    "PreparedVmdArtifactReceipt": ".prepared_vmd_artifact",
    "VmdExportDiscovery": ".prepare_vmd_export_action",
    "VmdExportPreparationBackend": ".prepare_vmd_export_action",
    "VmdExportRevisionProvider": ".prepare_vmd_export_action",
    "request_fingerprint": ".prepare_vmd_export_action",
