...
_CATEGORY_TEXT = {
    ...
    "animation": {
        "expected": "VMD frame names, ranges, interpolation payloads, and numeric values must be valid.",
        "impact": "The exported motion would be malformed or ambiguous.",
        "remediation": "Repair the current character-scene VMD frame payload.",
    },
    "physics": {
...
_WARNING_LOSS_POLICIES = frozenset()
