...
class BodyPickerWidget(SvgPickerWidget):
    ...
    def __init__(self, parent=None):
        super().__init__(
            ...
            tooltip_labels={
                **{region["id"]: region["id"] for region in _BODY_REGIONS},
                "select_all": "Select all bones in the current MMD model",
                "clear_selection": "Clear selection",
                "reset_pose": "Reset selected bones to the bind pose",
                "fingers_left": "Open the finger picker",
                "fingers_right": "Open the finger picker",
                "ik_enable_left": "Toggle left leg IK",
                "ik_enable_right": "Toggle right leg IK",
            },
