...
class MaterialTab(BaseTab):
    ...
    def _create_material_details_section(self):
        ...
        # PMX stores an exponent, not a normalized color component.
        self.specular_coefficient_spin.setRange(0.0, 3.402823466e38)
        self.specular_coefficient_spin.setSingleStep(0.01)
        self.specular_coefficient_spin.setDecimals(6)
        self.specular_coefficient_spin.setKeyboardTracking(False)
        self.specular_coefficient_slider = QSlider(Qt.Horizontal)
        # The slider covers common exponents; numeric input retains the full range.
        self.specular_coefficient_slider.setRange(0, 12800)
