...
class PmxMorph:
    ...
    def parse(self, f: BinaryIO) -> None:
        ...
        for _ in range(self.offset_count):
            ...
            if self.morph_type == PmxMorphType.GroupMorph:
                ...
                offset_data["material_index"] = struct.unpack(self.type_formats["material"], f.read(self.material_index_size))[
                    0
                ]
    ...
    def write(self, f: BinaryIO) -> None:
        ...
        f.write(
            struct.pack(
                "<B",
                self.morph_type.value if isinstance(self.morph_type, PmxMorphType) else self.morph_type,
            )
        )
