...
used from tests, ``mayapy`` and the product tool plug-in.
...
def _maya_cmds():
    try:
        ...
        raise NameTranslationError("name translation must run inside Maya or mayapy") from exc
    return cmds


def main(argv: Optional[Sequence[str]] = None) -> int:
    """CLI entry point for direct mayapy use."""
