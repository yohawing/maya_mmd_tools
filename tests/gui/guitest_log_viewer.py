...
from mmd_tools.ui.components.enhanced_log_viewer import EnhancedLogViewer
...
class GuiTestLogIntegration(unittest.TestCase):
    ...
    def test_logger_integration(self):
        ...
        self.assertGreaterEqual(
            added_logs, 5, f"Expected at least 5 logs, but got {added_logs}. Initial: {initial_count}, Current: {current_count}"
        )
    ...
    def test_log_level_filtering_in_gui(self):
        ...
        self.assertGreaterEqual(total_logs, 3, f"Expected at least 3 logs, but got {total_logs}")
    ...
    def test_log_colors(self):
        ...
        for level in expected_levels:
            self.assertIn(level, levels_found, f"Log level {level} not found in log entries")
