...
class TestMaterialPresenter(unittest.TestCase):
    ...
    def test_load_material_properties_dx11shader(self, mock_maya_utils, mock_cmds):
        ...
        mock_cmds.attributeQuery.side_effect = lambda attr, **kwargs: attr in [
            "DiffuseColorRGB", "SpecularColor", "AmbientColor", "MainTexture"
        ]
    ...
    def test_update_color_widget_with_valid_color(self):
        ...
        widget.setStyleSheet.assert_called_with(
            "background-color: rgb(255, 127, 0); border: 1px solid black;"
        )
    ...
    def test_update_color_widget_with_invalid_color(self):
        ...
        widget.setStyleSheet.assert_called_with(
            "background-color: rgb(128, 128, 128); border: 1px solid black;"
        )
