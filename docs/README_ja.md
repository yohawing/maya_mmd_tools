...
| モーフ（頂点・ボーン・マテリアル・グループ・UV） | 🔶 | 頂点・ボーン・マテリアル・グループの操作に対応。UV・Flip・Impulseは未対応。 |
...
- **UV、Flip、Impulse モーフは未対応です。** 頂点・ボーン・マテリアル・グループの操作に対応しますが、マテリアルの再現性は使用中のshader backendに依存します。
