 ...
 * ``values[frame_index * channel_count + channel_index]``.  The request must
 * explicitly carry the ``maya_timeline_bake_v1`` evaluation policy; there is
 * no alternate DG-context production path.
 */
